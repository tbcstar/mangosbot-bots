DROP TABLE IF EXISTS `playerbot_custom_strategy`;
CREATE TABLE `playerbot_custom_strategy` (
...
DELETE FROM `playerbot_custom_strategy`;
INSERT INTO `playerbot_custom_strategy` VALUES
