...
void WorldPacketHandlerStrategy::InitTriggers(std::list<TriggerNode*> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "often",
        NextAction::array(0, new NextAction("security check", relevance), new NextAction("check mail", relevance), nullptr)));
    ...
    triggers.push_back(new TriggerNode(
        ...
        NextAction::array(0, new NextAction("delay", relevance), nullptr)));
