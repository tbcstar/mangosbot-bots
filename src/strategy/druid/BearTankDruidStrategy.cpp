...
private:
    ...
    static ActionNode* feral_charge_bear()
    {
    ...
    static ActionNode* dire_bear_form()
    {
    ...
    static ActionNode* demoralizing_roar()
    {
...
BearTankDruidStrategy::BearTankDruidStrategy() : FeralDruidStrategy(botAI)
{
